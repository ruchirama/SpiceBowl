            ...
            <Card className="overflow-hidden rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <CardContent className="p-6 bg-gradient-to-br from-white to-orange-50">
                ...
                <p className="text-gray-700">
                  Founded in 1985 by the Perera family, SpiceBowl has been serving authentic Sri Lankan cuisine for over three decades. What started as a small family-run eatery has grown into one of most beloved restaurants, known for its warm hospitality and mouthwatering dishes.
                </p>
